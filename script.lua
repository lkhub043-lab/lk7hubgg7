...
-- whitelist
local whitelist = {}
local url = "https://pastebin.com/raw/U4xGsV2D"
...
if not isWhitelisted() then
    ...
    f.Size = UDim2.fromOffset(400, 160)
    ...
    t.Position = UDim2.fromOffset(20, 20)
    t.BackgroundTransparency = 1
    t.TextWrapped = true
    t.Text = "ACCESS DENIED\nNOT AUTHORIZED"
    t.Font = Enum.Font.GothamBlack
    t.TextSize = 21
    t.TextColor3 = Color3.fromRGB(80, 255, 240)
